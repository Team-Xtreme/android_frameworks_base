...
public class CarrierLabel extends TextView implements DarkReceiver {
    ...
    private NitrogenSettingsObserver mNitrogenSettingsObserver;
    ...
    public CarrierLabel(Context context, AttributeSet attrs, int defStyle) {
        ...
        mNitrogenSettingsObserver = new NitrogenSettingsObserver(new Handler());
        mNitrogenSettingsObserver.observe();
        updateSize();
        updateFont();
    }
    ...
    private class NitrogenSettingsObserver extends UserContentObserver {
        NitrogenSettingsObserver(Handler handler) {
            super(handler);
        }
